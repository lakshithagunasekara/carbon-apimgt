...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String ADD_GW_PUBLISHED_API_DETAILS = "INSERT INTO AM_GW_PUBLISHED_API_DETAILS (API_ID, " +
            "API_NAME, API_VERSION, TENANT_DOMAIN, API_PROVIDER ) VALUES (?,?,?,?,?)";

    public static final String ADD_GW_API_ARTIFACTS = "INSERT INTO AM_GW_API_ARTIFACTS (API_ID, GATEWAY_LABEL, " +
            "ARTIFACTS, ARTIFACT_TYPE) VALUES (?,?,?,?)";

    public static final String UPDATE_API_ARTIFACT = "UPDATE AM_GW_API_ARTIFACTS SET ARTIFACTS = ?, ARTIFACT_TYPE = ?" +
            " WHERE (API_ID = ?) AND (GATEWAY_LABEL = ?)";

    public static final String DELETE_GW_PUBLISHED_API_DETAILS = "DELETE FROM AM_GW_PUBLISHED_API_DETAILS WHERE API_ID = ?";

    public static final String DELETE_GW_PUBLISHED_API_ARTIFACTS = "DELETE FROM AM_GW_API_ARTIFACTS WHERE " +
