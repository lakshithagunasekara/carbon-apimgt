...
public class OperationPoliciesApiServiceImpl implements OperationPoliciesApiService {
    ...
    public Response getAllCommonOperationPolicies(Integer limit, Integer offset, String query,
        ...
        try {
            ...
            if (query != null) {
                ...
                APIPolicyData policyData = apiProvider.getCommonOperationPolicyByPolicyName(name, version,
                        organization, false);

                // if not found, throw not found error
                if (policyData != null) {
                    List<APIPolicyData> commonOperationPolicyLIst = new ArrayList<>();
                ...
                List<APIPolicyData> commonOperationPolicyLIst = apiProvider.getAllCommonOperationPolicies(
                        organization);
    ...
    public Response exportOperationPolicy(String name, String version, String format, MessageContext messageContext)
        ...
        APIPolicyData policyData = apiProvider.getCommonOperationPolicyByPolicyName(name, version, organization,
                true);
        if (policyData != null) {
